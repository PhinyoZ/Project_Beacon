...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['action']) && $_POST['action'] === 'edit') {
        ...
        if (isset($_POST['student_id']) && isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['id'])) {
            ...
            header("Location: of_manage_students.php");
            exit();
        }
        ...
        if (isset($_POST['student_id'])) {
            ...
            $_SESSION['alert_message'] = "ข้อมูลนักศึกษาลบเรียบร้อยแล้ว";
            $_SESSION['alert_type'] = "success";
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- ฟิลเตอร์การค้นหา -->
        <form method="GET" action="of_manage_students.php" class="form-inline mb-3">
                    ...
                    <?php foreach ($students as $student): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- ปุ่มลบ -->
                                <form method="POST" action="of_manage_students.php" style="display:inline;">
                                ...
                                <div class="modal fade" id="editStudentModal-<?php echo $student['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editStudentModalLabel-<?php echo $student['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="of_manage_students.php">
