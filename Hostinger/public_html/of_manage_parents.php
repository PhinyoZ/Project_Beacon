...
<body>
    ...
    <div class="container">
        ...
        <!-- ฟิลเตอร์การค้นหา -->
        <form method="GET" action="of_manage_parents.php" class="form-inline d-flex align-items-center mb-3">
                    ...
                    <?php foreach ($parents as $parent): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- ปุ่มลบข้อมูล -->
                                <form method="POST" action="of_manage_parents.php" style="display:inline;">
                                ...
                                <div class="modal fade" id="editParentModal-<?php echo $parent['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editParentModalLabel-<?php echo $parent['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="of_manage_parents.php">
