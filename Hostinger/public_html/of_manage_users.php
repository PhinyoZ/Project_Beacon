...
$query = "SELECT id, user_id, name_line, role, status, created_at FROM user 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['user_id']) && isset($_POST['new_role'])) {
        ...
        header("Location: of_manage_users.php");
        exit();
    }
...
<head>
    ...
    <style>
        ...
        .btn-edit:hover {
            background-color: #e0a800 !important; /* สีเหลืองเข้มขึ้นเมื่อ hover */
        }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="welcome4.php">หน้าหลักผู้ดูแลหอพัก</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <!-- ฟิลเตอร์การค้นหา -->
        <form method="GET" action="of_manage_users.php" class="form-inline mb-3">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr>
                         <td data-label="(LINE ID)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($user['user_id']); ?></td>
                            <td data-label="ชื่อใน LINE"><?php echo htmlspecialchars($user['name_line']); ?></td>
                                ...
                                <div class="modal fade" id="editRoleModal-<?php echo $user['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editRoleModalLabel-<?php echo $user['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="of_manage_users.php">
